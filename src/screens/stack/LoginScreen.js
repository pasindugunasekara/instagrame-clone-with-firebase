...
const LoginScreen = ({ navigation }) => {
    ...
    const GoogleSignIn = async () => {
        try {
            ...
            const credential = await auth()
                ...
                .then(creteUser => {
                    const { displayName, email, metadata, uid, photoURL, phoneNumber } =
                        creteUser.user;
    ...
    return (
        <Center flex={1} style={styles?.container}>
            {/* header: logo name */}
            <Text fontSize="5xl" style={styles?.textLogo}>
                Inxtagram
            </Text>
            ...
            <View style={styles?.hrLine}>
                <Text fontSize="sm" style={styles?.hrText}>
                    OR
                </Text>
            </View>
            ...
            <View style={styles?.footer}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('SignUp')}>
                    <Text fontSize="sm" style={{ color: colors?.blue }}>
                        Sign up.
                    </Text>
                </TouchableOpacity>
            </View>
